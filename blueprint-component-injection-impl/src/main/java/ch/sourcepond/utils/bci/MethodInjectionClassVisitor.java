...
public class MethodInjectionClassVisitor extends SerializableClassVisitor {
	...
	private static final String GET_COMPONENT_DESC = getMethodDescriptor(getType(Object.class), getType(String.class));
	...
	protected boolean isEnhancementNecessary() {
		return inspector.getComponents().length > 0;
	}
