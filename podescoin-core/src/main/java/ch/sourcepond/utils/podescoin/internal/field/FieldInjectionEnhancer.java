...
final class FieldInjectionEnhancer extends Enhancer {
	...
	FieldInjectionEnhancer(final boolean pEnhanceMode, final DefaultStreamCallGenerator pDefaultReadGenerator,
